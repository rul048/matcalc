...
BENCHMARK_DATA_URL: str = "https://api.github.com/repos/materialyzeai/matcalc/contents/benchmark_data"
BENCHMARK_DATA_DOWNLOAD_URL: str = "https://raw.githubusercontent.com/materialyzeai/matcalc/main/benchmark_data"
